...
def main_page():
    ...
    with col2:
        ...
        with tab2:
            fig2 = px.scatter(data_frame=train_df, x = "bmi", y = "charges", color_discrete_map= ["crimson"], trendline = "ols")
        ...
        with tab3:
            fig3 = px.scatter(data_frame= train_df, x = "age", y = "charges", color_discrete_map= ["darkviolet"] , trendline = "ols")
